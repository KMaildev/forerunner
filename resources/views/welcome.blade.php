...
@section('content')
    ...
    <section class="construction-section" style="border-radius: 10% 10% / 10% 10%;">
        ...
        <div class="auto-container">
            <div class="row clearfix">
                ...
                @foreach ($countries as $c)
                    <div class="construction-block col-lg-4 col-md-6 col-sm-12 py-3">
    ...
    <section class="news-section"   style="background-image:url({{ asset('data/World_Map_Blank.svg') }})">
        <div class="auto-container">
            <div class="row clearfix">
                <div class="col-md-12">
                    <div class="sec-title centered">
